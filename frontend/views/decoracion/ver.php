...
-->
                    ...
                    <div id="cantidad-fotos">
                        <label class="total-imagenes"><?= $total_imagenes = count($fotos) + 2; ?> Fotos</label>
                    </div>
                    <div>
...
<!--                            <img src="<?= $producto_form->imagen_personalizada ?>" />-->
            ...
            <div id="datos-producto" class="col-md-5 col-sm-12 bloque-ver-compra col-xs-12">
                ...
                <div class="row fondo-gris">
                    <div class="col-md-12">
                            <div class="price-info" id="precio-variante"></div>
                        </p>
                    </div>
                </div>
                <hr>
                    <?php $form = ActiveForm::begin([
                        ...
                        'action' => ['decoracion/agrega-carrito']
                        ]
                    );
                    ?>
                    <?= $form->field($producto_form, 'producto')->hiddenInput()->label(false); ?>
                    <?= $form->field($producto_form, 'talla')->hiddenInput(['value' => '1'])->label(false); ?>
                    <?= $form->field($producto_form, 'costo_variante')->hiddenInput()->label(false); ?>
                    <input type="hidden" id="id-decoracion" value="<?= $producto->id ?>" />
                    <div class="row equal campo-variante fondo-gris">
                        <div class="col-md-12 col-sm-12 col-xs-12 bloque-botones">
                            <p class="titulos-sub">
                                Color:
                            </p>
                            <?= $form->field($producto_form, 'color_decoracion')
                                ->dropDownList(
                                    $colores,
                                    ['prompt'=>'Color']
                                )->label(false); ?>
                    ...
                    <div class="row equal campo-variante fondo-gris">
                        <div class="col-md-12 col-sm-12 col-xs-12 bloque-botones">
                            ...
                            <?= $form->field($producto_form, 'medida_decoracion')
                                ->dropDownList(
                                    [],
...
<div class="float-bottom hidden-md container-fluid">
    <div class="row">
        ...
        <div class="col-sm-3 col-xs-3">
            <a href="<?= Url::to(['decoracion/ver', 'id' => $bomber->id]) ?>">
