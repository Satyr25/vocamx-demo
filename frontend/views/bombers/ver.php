...
<?php
    ...
    $video2 = 'VzBuUs1npls';
    $video3 = 'lUQxyRchTg8';
if ($producto->clave_categoria == 'HOP'){
    $video1 = '80-o2mikByQ';
} if ($producto->clave_categoria == 'HOOD'){
    $video1 = 'TOAa_NxA0OE';
}
?>
...
-->
                        ...
                        <div class="foto youtube">
                            <a href="https://www.youtube.com/watch?v="<?= $video1 ?>"&feature=youtu.be" class="youtube-link hidden"></a>
                            <iframe src="https://www.youtube.com/embed/<?=$video1 ?>?enablejsapi=1&version=3&playerapiid=ytplayer&rel=0"  class="youtube-iframe carrusel" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <div class="cover1"></div>
                            <div class="cover2"></div>
                        </div>
                        <?php if($producto->clave_categoria != 'HOP'){ ?>
                        <?php if($producto->clave_categoria != 'HOOD'){ ?>
                            <div class="foto youtube">
                                <a href="https://www.youtube.com/watch?v=<?= $video2 ?>&feature=youtu.be" class="youtube-link hidden"></a>
                                <iframe src="https://www.youtube.com/embed/<?= $video2 ?>?enablejsapi=1&version=3&playerapiid=ytplayer&rel=0"  class="youtube-iframe carrusel" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                <div class="cover1"></div>
                                <div class="cover2"></div>
                            </div>
                            <div class="foto youtube">
                                <a href="https://www.youtube.com/watch?v=<?= $video3 ?>&feature=youtu.be" class="youtube-link hidden"></a>
                                <iframe src="https://www.youtube.com/embed/<?=$video3 ?>?enablejsapi=1&version=3&playerapiid=ytplayer&rel=0"  class="youtube-iframe carrusel" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                <div class="cover1"></div>
                                <div class="cover2"></div>
                            </div>
                        <?php } ?>
                ...
                <div id="thumb-fotos">
                    <?php if(isset($photoForm)): ?>
                        <div class="foto">
                            <?= Html::img('@web/images/'.$photoForm->fotoRoute) ?>
                        ...
                        <p class="price-info">
                            <?php if ($precio_desc != null & $precio_desc > 0 ): ?>
                                ...
                                <?php if($producto->moneda == ' MXN'){ ?>
                                    $<?= number_format(($precio_desc), 0), $producto['moneda'];  ?>
                                <?php } else { ?>
                                    $<?= number_format(($precio_desc), 2), $producto['moneda'];  ?>
                                <?php } ?>
                    ...
                    <?php if($bomber->status == 1){ ?>
                        ...
                        <div class="bloques-best text-center <?php echo ($i > 2  ? 'hidden-mobile' : ''); ?> <?php echo ($i < 2 ? 'col-sm-6 col-xs-6' : ''); ?>">
                            <a href="<?= Url::to(['bombers/ver', 'id' => $bomber->id]) ?>">
                                ...
                                <p class="bomber-discount"><s>$<?= $precio, $moneda ?></s></p>
...
<div class="float-bottom hidden-md container-fluid">
    <div class="row">
