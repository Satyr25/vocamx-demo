 ...
 */
class ContenidoGarantiasForm extends Model
{
     public $id;
    ...
    public function rules()
    {
        return [
            [['id'], 'required'],
            [['bloque1_titulo', 'bloque2_titulo', 'bloque3_titulo', 'bloque4_titulo', 'bloque5_titulo', 'bloque1_texto', 'bloque2_texto', 'bloque3_texto', 'bloque4_texto', 'bloque5_texto', 'bloque5_texto2', 'bloque5_correo', 'enlace1' ], 'string'],
            [['id'], 'integer'],
    ...
    public function actualizar(){
        ...
        $contenido = ContenidoGarantias::find()->one();
        if(!$contenido){
            $contenido = new ContenidoGarantias();
        }
        ...
        $contenido->bloque5_correo = $this->bloque5_correo;
        ...
        $ruta2 = $this->guardaImagenes('imagen2');
        if($ruta2){
            $contenido->imagen2 = $ruta2;
        }
